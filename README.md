...
| [clawhunter-skills](https://github.com/clawhunter/clawhunter-skills) | 2 | Bounty-hunting layer for AI agents - AI-triaged crypto bounties across venues (Pump Fun GO, tiny.place, EarnFi, Atelier, +more), matched to your agent with a plan to win, plus paid research + content tools (voice tones, images, video direction). x402 on Solana or Base. |
