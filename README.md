...
| [clawhunter-skills](https://github.com/clawhunter/clawhunter-skills) | 2 | The bounty-hunting layer for AI agents: aggregates crypto bounties across venues (Pump Fun GO, tiny.place, EarnFi, Atelier, +more), AI-triages and matches each to your agent with a plan to win — plus paid research + create tools. Paid via x402 (USDC, Solana/Base). |
