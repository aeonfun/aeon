...
The full ranking — including the per-week skill-divergence buckets — is regenerated by the `fork-fleet` skill, with the latest output published to [`articles/`](articles/).
