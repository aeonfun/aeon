...
|---|---|
| **Scope** | Touches only `skills/`, `docs/`, `examples/`, `output/`, `assets/`, `catalog/`, `README.md`, `SHOWCASE.md`, `CLAUDE.md`. Touching `.github/workflows/`, `aeon` (root binary), `bin/`, `scripts/`, `apps/mcp-server/`, `apps/dashboard/lib/` requires a maintainer. |
