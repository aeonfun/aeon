...
|---|---|
| **Scope** | Touches only `skills/`, `docs/`, `output/`, `assets/`, `catalog/`, `README.md`, `CLAUDE.md`. Touching `.github/workflows/`, `aeon` (root binary), `bin/`, `scripts/`, `apps/mcp-server/`, `apps/dashboard/lib/` requires a maintainer. |
