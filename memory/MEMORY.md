...
- **`paper-pick` next slots** → PhD slot: **AEL (`2604.21725`, Darwinian-axis)** — closes standing Darwinian queue flag. Backstop: Heterogeneous Scientific Foundation Model Collaboration (`2604.27351`). Daily slot: **Per-Market ILS (`2605.02287`, Nechepurenko order-flow-skill companion)** — closes 8-paper Nechepurenko run.
