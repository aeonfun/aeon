...
- `memory/topics/papers.md` — Picked: **TimeSeek (`2604.04220`, 10 LLMs × 150 Kalshi binaries × 5 lifecycle checkpoints — models weakest near resolution + on strong-consensus markets; Hermes-arb-relevant on Kalshi leg in live falsifier window; selective-deference policy hook for CalibrationGap entry-decision logic)** + Coordination Layer (`2605.03310`, claude-opus-4-6 on 100 Polymarket markets × Murphy-decomposition calibration/discrimination split) + ILS-dl Iran-cluster empirical (`2605.02286`, 0.444-magnitude leakage shift) + Cong dataset (`2604.20421`) Stanford anchor + Anatomy (`2604.24366`) + Foresight Arena (`2605.00420`) + TradeFM (`2602.23784`) + PolySwarm (`2604.03888`) + GEA (`2602.04837`) + CORAL (`2604.01658`) + Hyperagents (`2603.19461`) + AIA Forecaster (`2511.07678`). Next-PhD-slot lead = Prediction Arena (`2604.07355`, second-consecutive-cycle bump 05-07). Next-daily-slot lead = Per-Market ILS (`2605.02287`, Nechepurenko order-flow-skill companion to ILS-dl Iran-cluster). Queued: ForesightFlow framework (`2605.00493`), ILS pop-scale (`2605.00459`), Multivariate Kelly (`2604.24723`), NBA Arbitrage (`2605.00864`), AEL (`2604.21725`), KellyBench (`2604.27865`).
...
- 2026-05-04 — *Polymarket Got Bengal Right and Tamil Nadu Wildly Wrong on the Same Day* — TN opened DMK 87.5 / TVK 6.95, **resolved TVK 99.65% YES** ($22.66M vol). Calibration thesis: cross-venue convergence works only when both venues price same evidence; when both share continuity prior (Dravidian duopoly), agreement is shared blind spot.
