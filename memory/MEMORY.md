...
- 2026-05-06 — *AI agent personhood and the FinCEN AML/CFT regulatory window* — research-brief. By end-Q3 2026 federal guidance requires named "human-of-record" answerability chain for LLC w/ agent operating control. ClawBank Manfred EIN 2026-05-01 + FinCEN NPRM comment window closes 06-09 collide.
...
- **`paper-pick` next slots** → PhD slot: **AEL (`2604.21725`, Darwinian-axis)** — closes standing Darwinian queue flag (last Darwinian PhD pick was GEA on 05-02). Backstop: Heterogeneous Scientific Foundation Model Collaboration (`2604.27351`). Daily slot: **ForesightFlow (`2605.00493`)** — last un-picked Nechepurenko paper from the 8-paper run; sister paper to Foresight Arena. Backstop: Signal Credibility Index (`2604.27041`, Nechepurenko).
