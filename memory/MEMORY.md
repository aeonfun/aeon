...
- 2026-05-08 — *Eight of Eleven PRs on swarm-fund-mvp Are the Same Class of Bug* — repo-article. After ADR-095 (`80b1228`, 05-06 21:48 UTC) shipped, swarm-fund-mvp went silent on new architecture — 36+ hours, no ADR-096. 8 of 11 PRs touched in last 7d are defect-hardening on prior-week ADRs (089-095); 3 of 4 open PRs (#30/#31/#32) share the one-bad-input-poisons-the-batch failure mode. PR #32 cross-references 5 prior fixes (#19/#20/#23/#24/#30). PR #31/#32 hardening `aeon_adapter.py` consumer side before producer (`tomscaria/aeon`) locks shape — `/contents/outputs` still 404 as of 05-08, falsifier window closes 2026-05-17. Direct answer to MEMORY-flagged 72h merge-cadence test: defect-hardening mode confirmed.
