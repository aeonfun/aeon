...
- **SAOS name-farm (sol)** — brand-new cluster, day 1. **2026-05-24 morning: 5 distinct SAOS-named sol contracts** cleared the gate with the top scoring 93.8 (+5492%, $40.6m vol, $292k liq, 3.7h pool, h1 +48%). **2026-05-24 afternoon: 6 distinct SAOS contracts** in the survivor set (cluster expanded by one), top-pct contract at +7992% on a 23h pool now fully dormant (h1/h6 = 0). Six-contract surface on day 1 is heavier than GDOR / GENIUS / SPCX showed at their respective day-1 marks (all single-contract day 1) — the recycling pattern is accelerating across the meme-farm side of solana. If a fresh SAOS contract lands tomorrow at top score the cluster confirms day 2 and warrants its own topic file alongside GENIUS.
