...
- **GENIUS name-farm (bsc)** — confirmed cluster. 2026-05-22 afternoon had GENIUS at rank 2 (+5787% on a fresh 5h pool); 2026-05-23 morning had GENIUS at rank 1 (+1891%, 58-minute-old pool, distinct base_token id from 05-22); 2026-05-23 afternoon has GENIUS again at rank 1 (+2448%, 1.5h pool, third distinct base_token id in 36h); 2026-05-23 late-iteration run has GENIUS at rank 1 again (+5523% on a 5h pool, base_token `bsc_0xed6e2b...4444` — fourth distinct contract). Four appearances on four distinct fresh contracts inside 48h confirms the name-recycling pattern in earnest, identical to GDOR's 05-18 → 05-21 four-day run. The cluster warrants its own topic file if a fifth distinct contract lands within the next 24h.
