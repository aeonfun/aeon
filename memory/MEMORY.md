...
- **SAOS name-farm (sol)** — day-2 confirmed cluster. **2026-05-24 morning: 5 distinct SAOS-named sol contracts** cleared the gate (top score 93.8, +5492%, $40.6m vol, $292k liq, 3.7h pool, h1 +48%). **2026-05-24 afternoon: 6 distinct SAOS contracts** (cluster expanded by one), top-pct contract +7992% on a 23h pool fully dormant. **2026-05-25 morning: 5 distinct SAOS contracts again** with top contract at rank 4 (+9661% on $43.1m vol / $337k liq, 13h pool, h1 0% / h6 -1.9%) — lead pool dormant, cluster still surfacing five-deep into the survivor set on day 2. **2026-05-26: decayed** to a single mid-table contract (rank 12). **2026-05-27 afternoon: reactivated** to 3 contracts (rank 5, +502%, fresh 6.2h sibling). **2026-05-28: reactivation holds** a second straight session, 4 contracts (rank 5, +437%, fresh 6h sibling carrying +437% h6). Burst-mode signature matches GENIUS / NOAR (day-1 → pause → reactivation). Warrants its own topic file at next memory-flush (alongside GENIUS / NOAR).
- **NOAR name-farm (sol)** — multi-day cluster, crosses the 3-day-in-a-row flag rule. Top 5 on **05-25 morning (rank 1, +491%)**, **05-26 morning (rank 2) + afternoon (rank 4)**, **05-27 morning (rank 4)**, **05-28 (rank 1, +657%, score 88.5)** — five sessions across four calendar days, each on a fresh recycled sol contract. 05-28 surfaced 4 distinct NOAR contracts (scores 88.5 / 83.6 / 80.8 / 80.0 on $37-41m vol against $209-281k liq); lead pools go dormant (h1=h6=0) while the freshest sibling carries the burst (05-28: 2.4h sibling at +389% h6 / +10% h1). Same recycling / burst-mode lineage as SAOS / GENIUS / GDOR / SPCX. Warrants a dedicated topic file at next memory-flush.
