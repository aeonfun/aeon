...
| DESIGNER | Designer | Crypto product, brand, UI/UX, or visual-identity work. |
...
| EXCHANGE | Exchange | CEX or DEX-affiliated accounts, listings, volume, incidents. |
...
| MACRO | Macro | TradFi, rates, liquidity, equities, commodities, geopolitics. |
| MARKETING | Marketing | Growth, community, content, campaigns, brand narrative. |
| MEDIA | Media | Journalists, podcasts, crypto-native outlets, beat coverage. |
| NFT_COLLECTOR | NFT Collector | PFPs, floors, mints, and collection lore. |
| OG | OG | Long-cycle crypto veteran with early-cycle references. |
...
| TRENCHER | Trencher | Perps, memecoins, leverage, liquidation-risk culture. |
| VC | VC | Thesis threads, portfolio wins, fund or network perspective. |
| WEB3_GAMER | Web3 Gamer | On-chain game player, meta, tournaments, gameplay strategy. |
| YIELD_FARMER | Yield Farmer | DeFi APY rotation, liquidity incentives, emissions. |
