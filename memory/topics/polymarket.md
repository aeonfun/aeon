...
- **monitor-polymarket 05-02 quiet:** No >5pp movers on watched markets. Bitcoin $1M before GTA VI: YES 48.85%, vol drought 0.27x 7d-avg. GTA VI event has top "SCAM market — READ THE RULES" comment (12 rxn, Downright-Juice) → resolution-criteria ambiguity live; CalibrationGap should not enter without rule-read. Revenant first order (Mexico YES 1.05%) flat all 24h on $78.5K vol.
